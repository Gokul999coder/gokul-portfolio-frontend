...
const TIMELINE = [
  {
    ...
    desc: 'Currently in 7th semester with CGPA 7.69. Focused on full-stack development, data structures, and software engineering fundamentals.',
    tags: ['Full Stack', 'Java', 'React', 'CGPA 7.69'],
    color: '#a855f7',
    icon: '🎓',
  },
  {
